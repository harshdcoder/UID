...
con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1522:xe","rishi","rishi");
...
out.println("<b>The Current Status is Police Verification Completed for Ano <font color=red>" + t1 + ", Awaiting Dispatch.");
...
System.out.println("Image path in passpost>>>>>>>>>>>>>>>>"+path);
...
out.println("<tr><td>Photo</td><td><img src='" + path + "' width=75 height=75/></td><td></td></tr>");
