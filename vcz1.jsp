...
out.println("<td><input type=text size=10 name=pin value= " + rs.getString(10) +"></td><tr><td><font size=1>Gender</td><td><font size=1><input type=text size=10 value=" + rs.getString(11) +"></td>");
